...
async function findUnitsCloseOrOpen() {
    ...
    for (let i = 0; i < listUnits.locations.length; i++) {
        ...
        let mask = listUnits.locations[i].mask === "required" ? "../images/required-mask.png" : "../images/recommended-mask.png";
        let towel = listUnits.locations[i].towel === "required" ? "../images/required-towel.png" : "../images/recommended-towel.png";
        let fountain = listUnits.locations[i].fountain === "not_allowed" ? "../images/forbidden-fountain.png" : "../images/partial-fountain.png"
        let lockerroom = listUnits.locations[i].locker_room === "allowed" ? "../images/required-lockerroom.png"
            : listUnits.locations[i].locker_room === "partial" ? "../images/partial-lockerroom.png" : "../images/forbidden-lockerroom.png";
